...
describe('DataService', () => {
    ...
    it('should get data', () => {
        ...
        service.getData().subscribe((data) => {
         ...
         const request = httpMock.expectOne('assets/data/units.json');
    ...
    it('should return units', () => {
        const data = [
            { id: 1, name: 'unit1', age: 'Age1', cost: { Wood: 10, Gold: 20 } },
            { id: 2, name: 'unit2', age: 'Age2', cost: { Wood: 30, Gold: 40 } }
          ];
          const result = service.getTableData(data);
          expect(result.length).toBe(2);
          expect(result[0]).toEqual({ id: 1, name: 'unit1', age: 'Age1', cost: { Wood: 10, Gold: 20 } });
          expect(result[1]).toEqual({ id: 2, name: 'unit2', age: 'Age2', cost: { Wood: 30, Gold: 40 } });
    }); 
